...
public class BookController extends HttpServlet {
    ...
    private static final String SEARCH_BOOKS_PAGE = "/bookSearchWizard.jsp";
    ...
    private static final String ENTER_SEARCH_ACTION = "enterSearch";
...
//                        }
                ...
                case SEARCH_ACTION:
                    ...
                    if(authorId.equals("All")) {
                        if(!isbn.isEmpty() && !title.isEmpty()) {
                             books = bookService.searchByIsbnAndTitle(isbn, title);
                        } else if(!isbn.isEmpty() && title.isEmpty()) {
                            books = bookService.searchByIsbn(isbn);
                        } else {
                            books = bookService.searchByTitle(title);
                        }
                    } else {
                        Integer aId = new Integer(authorId); 
                        if(!isbn.isEmpty() && !title.isEmpty()) {
                             books = bookService.searchByAuthorIdAndIsbnAndTitle(aId, isbn, title);
                        } else if(!isbn.isEmpty() && title.isEmpty()) {
                            books = bookService.searchByAuthorIdAndIsbn(aId, isbn);
                        } else if(isbn.isEmpty() && !title.isEmpty()) {
                            books = bookService.searchByAuthorIdAndTitle(aId, title);
                        } else {
                            books = bookService.searchByAuthorId(aId);
                        }
                    }
                ...
                case ENTER_SEARCH_ACTION:
                    this.refreshAuthorList(request, authService);
                    destination = SEARCH_BOOKS_PAGE;
                    break;
